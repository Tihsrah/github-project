...
public class FirstClass {
    public static void main(String[] args) {
        ...
        // A variable name should start with an alphabetic character (like a, b, c,
        // etc.)
        ...
        // Each use of the variable in the code must match the variable name in the
        // declaration
        // exactly.
        // Never put variable name inside quotes (” “).

        // we can define our variables by lot of different types, those are called data
        // types.
        ...
        // The mod operator (x % y) returns the remainder after you divide x (first
        // number)
        ...
        // When you create a primitive variable Java will set aside enough bits in
        // memory
        ...
        // Wrapper classes- each one of the primitive types has a wrapper class like
        // Integer
        // Boolean Long etc.. the wrapper class gives us a way to perform operations on
        // the data type
        ...
        System.out.println("ALL of this is written by Mark sir. I am trying to clone it");
    }
}